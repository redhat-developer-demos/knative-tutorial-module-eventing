...
eventinghelloa-sub   True             81s
eventinghellob-sub   True             74s
----
...
kubectl -n {tutorial-namespace} delete -f channel.yaml
----
...
oc -n {tutorial-namespace} delete -f event-source.yaml
oc -n {tutorial-namespace} delete -f channel.yaml
----
